...
\todo{Ian editing}
Pre-main sequence stars in multiple systems can serve as extremely useful touchstones to precisely measure fundamental stellar properties during the final stages of stellar formation and the primary period of planet formation. While recent decades have seen steady progress in understanding binary formation in general, lingering uncertainties still remain about the characteristics of close in spectroscopic binaries and higher order systems \citep{duchene13}.

\gw\ was one of the first T Tauri stars to be revealed as a spectroscopic binary \citep{mathieu91}. It has a composite spectral type of late G and an orbital period of 240 days. Long term radial velocity monitoring revealed the presence of a third body in the system with a period of $\sim10\,$ years, which was subsequently confirmed by infrared interferometry \citep{berger11}. Despite concerted efforts, there have not been any detections of the spectroscopic lines from the secondary or tertiary stars in optical spectra to date. The most recent and precise measurements of the distance to \gw\ are the recent VLBA parallax measurements of the Orion Nebula Complex at $388\pm5\,$pc \citep{kounkel16}.

A reservoir of circumstellar material orbiting \gw\ was inferred from the near and far-infrared excess emission beyond that contributed from the stellar photosphere \citep{mathieu91}, and was subsequently confirmed by a strong single-dish sub-millimeter detection \citep{mathieu95}, indicating a large, massive circumstellar disk ($M_\mathrm{disk}/M_\ast > 0.1$). Quasi-periodic photometric dimminings of \gw\ have also been observed, and are suspected to be due from material in the circumstellar disk occulting the primary star \citep{shevchenko92,shevchenko98}, although the fact that the disk is not edge-on complicates this interpretation. \todo{correspond with Joey about KELT dimmings}.

Mid-infrared spectroscopic observations of \gw\ detected CO fundamental emission, presenting a complicated emission region and temperature structure in the inner disk \citep{najita03}. \citet{fang14} compile several epochs of spectral energy distributions (SEDs) and find that the mid-infrared emission is variable on the timescale of years. The changes in the SED can be explained by changes in the structure of the inner disk, and note that explaining the SED of \gw\ in general requires the presence of a disk with gaps.
...
Orbital constraints from radial velocity \citep{mathieu91,fang14} and astrometric \citep{berger11} measurements imply that the \gw\ system is massive ($M_\mathrm{tot} > 5\,M_\odot$) and that the the A component is a dominant component ($M_A > 3\, M_\odot$). Such a large mass with only a late G spectral type implies that \gw\ A (and thus the whole system) must be very young ($< 1$\,Myr) according to theories of pre-main sequence stellar evolution.

When it reaches the main sequence in $\sim10\,$ Myr, \gw\ A will have a B spectral type. B star lifetimes are notoriously short, and so the current state of \gw\ represents an interesting if brief snapshot in the evolutionary history of high mass stars. Enticingly, \gw\ might represent a younger analogue to the binaries recently discovered by \citep{moe15}, which are comprised of a main sequence B star with a pre-main sequence T~Tauri star companion. Refining the stellar properties of the \gw\ system will enable important tests of our understanding of pre-main sequence evolutionary models at the high mass end of the initial mass function.
...
Spatially and spectrally resolved sub-millimeter observations of molecular gas lines in protoplanetary disks can be used to reconstruct the disk velocity field and independently measure the total stellar mass of the system \citep[e.g.,][]{rosenfeld12b,czekala15a,czekala16}. We report the first resolved sub-mm observations of the \gw\ system with the ALMA interferometer, which reveal the presence of a large and massive protoplanetary disk. We forward-model the protoplanetary disk to infer the total mass of the enclosed stars, and derive an updated orbit using 35 years of radial velocity data. We combine these mass constraints with measurements of the photospheric properties of A to evaluate the agreement of A with leading pre-main sequence models. We discuss the structure and orientation of the protoplanetary disk with respect to the putative orbital inclinations of the stellar components and place the quasi-period eclipsing nature of \gw\ in the context of other recently discovered ``dipper'' stars \citep[e.g.,][]{ansdell16b,ansdell16a}.
