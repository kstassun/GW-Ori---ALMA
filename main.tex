...
\noalign{\hrule}
\noalign{\vskip 3pt}
$P$ [days]\dotfill                        &    241.49~$\pm$~0.05\phn\phn  & \\
$K_\mathrm{A}$ [\kms]\dotfill                 &        8.36~$\pm$~0.14 & \\
$q$ \dotfill & 0.60~$\pm$~0.02 & \\
$e$\dotfill                               &      0.13~$\pm$~0.02 & \\
$i$ [deg] \dotfill & \nodata & \\
$\omega_\mathrm{A}$ [deg]\dotfill                    &        196~$\pm$~7 & \\
$\Omega$\tablenotemark{b} [deg]\dotfill                    &  \nodata      & \\
$T_{\rm peri}$ [HJD$-$2,400,000]\dotfill   &      56681~$\pm$~4\phm{222} & \\
$\gamma$ [\kms]\dotfill                   &    +28.31~$\pm$~0.19\phn\phs & \\
$\Delta v$ TRES\tablenotemark{a} [\kms]\dotfill & 0.49~$\pm$~0.24 & \\
$\Delta v_2$ Reticon\tablenotemark{a} [\kms]\dotfill & 8.77~$\pm$~0.65 & \\
$\Delta v_2$ TRES\tablenotemark{a} [\kms]\dotfill & 6.41~$\pm$~0.37 & \\
...
\noalign{\hrule}
\noalign{\vskip 3pt}
$P$ [days]\dotfill                        &       4218~$\pm$~60\phn\phn & \\
$K_{\rm AB}$ [\kms]\dotfill                &       2.47~$\pm$~0.25 & \\
$e$\dotfill                               &      0.22~$\pm$~0.09 & \\
$i$ [deg] \dotfill & \nodata & \\
$\omega_\mathrm{AB}$ [deg]\dotfill                    &        307~$\pm$~18\phn & \\
$\Omega$\tablenotemark{b} [deg]\dotfill                    &    \nodata    & \\
...
$M_{\rm C} \sin i / (M_\mathrm{tot}\tablenotemark{c} / M_\odot)^{2/3} \; $[$M_{\sun}$]\dotfill            &     0.22~$\pm$~0.02 & \\
Time interval [cycles]\dotfill            &             3.1 & \\
\enddata
