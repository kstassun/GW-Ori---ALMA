...
\begin{figure*}[!ht]
\vspace{0.3in}
\centering\includegraphics[width=0.99\linewidth, trim = 0 5.8in 0 0.3in]{FULL_LC.pdf}
...
\begin{figure*}[!ht]
\vspace{0.3in}
\centering\includegraphics[width=0.99\linewidth, trim = 0 5.8in 0 0.3in]{FULL_Phased_LC.pdf}
...
\begin{center}
  ...
  \figcaption{Figures for the lightcurve and radial velocities. Radial-velocity measurements of \gw\ as a function of time, and best-fit model for the triple system. The dotted line represents the center-of-mass velocity.
  \label{fig:orbitboth}}
\end{center}
\end{figure*}
...
\begin{center}
  ...
  \figcaption{Figures for the astrometric fit.
  \label{fig:astro}}
\end{center}
\end{figure*}
