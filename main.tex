...
$a_\mathrm{A} = 1.24 \pm 0.02\,\mathrm{AU}$, $i_\mathrm{inner} = 155 \pm 8^\circ$, $\Omega_\mathrm{inner} = 265 \pm 12^\circ$, $a_\mathrm{AB} = 9.1 \pm 0.1\,\mathrm{AU}$, $i_\mathrm{outer} = 153 \pm 6^\circ$,
...
\subsection{Formation of the \gw\ system}
