...
\begin{center}
  ...
  \figcaption{\obj~A and B placed on the pre-Main Sequence HR diagram, with evolutionary tracks from \citet{choi16}. Mass tracks are in increments of $0.5\,M_\odot$ from $1.0 M_\odot$ to $4.0 M_\odot$, and isochrones label 0.1, 0.5, 1, 2 Myr ages.
  \label{fig:PMS}}
  \end{center}
\end{figure}
